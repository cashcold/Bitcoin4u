...
class ForgotPassword extends Component {
    ...
    onSubmit = (event)=>{
        ...
        .then(res => {
            toast.success("Link have sent to email address");
            setTimeout(() => {
        ...
        return ( 
            <div className='passwordForgot'>
                ...
                <div className='mainPassword'>
                    <h3 className='animate__animated animate__zoomInRight animate__slower'><span>RECOVERY</span> YOUR PASSWORD <span>VIA</span> INBOX</h3>
